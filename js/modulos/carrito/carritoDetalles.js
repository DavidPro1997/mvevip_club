function editarHeaderDetalles(){
    ...
    lista = `
        ...
        <div class="animated fadeInDown" style="position: absolute; bottom: 0; left: 20px; padding: 20px; color: white;">
            <button class="btn_1 green" style="background-color: var(--color-primario);" onclick="irCarrito()">
        ...
        <div class="animated fadeInDown" style="position: absolute; bottom: 0; right: 20px; padding: 20px; color: white;">
            <button class="btn_1 green" style="background-color: var(--color-primario);" onclick="validarReserva()">
                Continuar
...
function editarHeaderCarrito(){
    ...
    lista = `
        ...
        <!-- End bs-wizard -->
        <div class="animated fadeInDown" style="position: absolute; bottom: 0; right: 20px; padding: 20px; color: white;">
            <button class="btn_1 green" style="background-color: var(--color-primario);" onclick="irDetallesCarrito()">
                Continuar
                <i class="icon-left" style="font-size: 20px;"></i>
            </button>	
        </div>
