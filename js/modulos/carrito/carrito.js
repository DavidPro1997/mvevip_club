...
var protHotel=false
function verificarCarritoHoteles(){
                    ...
                    <div class="col-lg-6 col-md-6" style="position: relative;">
                        <div class="tour_list_desc">
                            ...
                            <div clas="row" style="display: flex;">
                                <div class="col-1">
                                    <i class="icon-location" style="font-size:15px; color:var(--color-primario);"></i>
                                </div>
                            ...
                            <div class="row" style="display: flex;">
                                <div class="col-1">
                                    <i class="icon-calendar" style="font-size:13px; color:var(--color-primario);"></i>
                                </div>
                                <div class="col-11">
                            ...
                            <p style="position: absolute; bottom: 0; right: 20px; margin: 0;">
                                <a href="#habitaciones`+element.hotel.code+`_`+index+`" data-bs-toggle="collapse">
                                    Ocultar/Mostrar <i class="icon-up-open-1" style="font-size:13px; color:var(--color-primario);"></i>
                                </a>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-6" style="overflow-y: auto; max-height: max-content;">
                            <div class="tour_list_desc">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="col-12">
                                            <span><i class="mdi mdi-seatbelt" style="font-size:20px; color:var(--color-primario);"></i></span>
                                            <span style="margin-left:10px; font-size:12px;">`+element.vehiculo.places+` Asientos</span>
                                        </div> 
                                        <div class="col-12">
                                            <span><i class="mdi mdi-bag-checked" style="font-size:20px; color:var(--color-primario);"></i></span>
                                            <span style="margin-left:10px; font-size:12px;">`+element.vehiculo.large_suitcase+` Equipajes facturado</span>
                                        </div>
                                        <div class="col-12">
                                            <span><i class="mdi mdi-bag-carry-on" style="font-size:20px; color:var(--color-primario);"></i></span>
